...
// GemmaGuard Enhanced Typography for Security Applications
val GemmaGuardTypography = Typography(
    // Display styles for hero text (splash screen, headers)
...
val Typography = GemmaGuardTypography
